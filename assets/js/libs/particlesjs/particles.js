...
window.particlesInit = function( params ){
    ...
    var particleCanvasContainers = document.querySelectorAll(".particles-js-container");

    if ( particleCanvasContainers !== null ){

        [].slice.apply( particleCanvasContainers ).forEach(function( el ){
