...
<body class="home page-template-default page vc_responsive sticky_header pt_portal_login" style="margin-top: 10px;">
                  ...
                  <tr>
                    ...
                    <td width="30%" height="371px" valign="top">
                      ...
                      <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                          ...
                          <tr>
                            <td colspan="2">
                                <input type="submit" id="submit_login" value="Log In" name="SubmitLogin">
                            </td>
                          </tr>

                          <tr>
                            <td colspan="2">
                                <span style="color:#002D59;">Forgot? 
  ...
  <div class="dark_section transparent_film">
    <div class="container">
      <div class="row">
        <div class="col-sm-6 col-md-6">Copyright © MD Health Clinics.</div>
        <div class="col-sm-6 col-md-6 text-right">All rights reserved.</div>
      </div>
    </div>
  </div>
</div>
