...
<div class="head_panel">
  <div
    style="background-image: url('images/PrescriptionAddiction.jpg'); height: 130px;"
      ...
      <div class="row">
          ...
          <div class="wpb_wrapper">
            ...
            <div class="wpb_text_column wpb_content_element ">
              <div class="wpb_wrapper">
                ...
                <h5 style="text-align: center;">
                  <strong>Your job is to simply “want to change enough to just be there”.</strong>
                </h5>
                <h5 style="text-align: center;">
                ...
                <p>&nbsp;</p>
                <p>
                  <img class="alignleft size-medium wp-image-2071" src="images/NGS.jpg" alt="NGS"
                    width="290" height="300"
                    srcset="images/NGS.jpg 290w, images/NGS.jpg 550w"
                ...
                <table>
                  <tbody>
                    <tr>
                      <td width="319"><strong>What is Person</strong>
                      <p></p>
                        <p>
                          <strong>Personality Development – Child</strong>
                        </p>
                        <p>
                          <strong>Personality Development – Adult</strong>
                        </p>
                        <p>
                          <strong>Defense Mechanisms</strong>
                        </p>
                        <p>
                          <strong>Personality Types Psychosis</strong>
                        </p>
                        <p>
                          <strong>Personality Types Addictions</strong>
                        </p>
                        <p>
                          <strong>Personality Types Neurosis</strong>
                        </p>
                        <p>
                          <strong>Becoming Aware, Moral Integration</strong>
                        </p>
                        <p>
                          <strong>Finding Faith</strong>
                        </p>
                        <p>
                          <strong>Developing Trust</strong>
                        </p>
                        <p>
                          <strong>The Unitive Way</strong>
                        </p>
                        <p>
                          <strong>The Next Good Step</strong>
                        </p>
                        <p>
                          <strong>Healing the Shame That Binds You</strong>
                        </p>
                        <p>
                          <strong>Healthy Family Secrets</strong>
                        </p></td>
                      <td width="319"><strong>Dangerous Family Secrets</strong>
                      <p></p>
                        <p>
                          <strong>The Most Dangerous Family Secrets</strong>
                        </p>
                        <p>
                          <strong>Tools for Deciphering Family Secrets</strong>
                        </p>
                        <p>
                          <strong>Breaking Free From the Secrets</strong>
                        </p>
                        <p>
                          <strong>Staying Connected to the Family</strong>
                        </p>
                        <p>
                          <strong>The Legacy of Shame</strong>
                        </p>
                        <p>
                          <strong>From Recovery to Discovery</strong>
                        </p>
                        <p>
                          <strong>Relapse Prevention, Overtaken</strong>
                        </p>
                        <p>
                        ...
                        <p>
                          <strong>Normality and Adjustment</strong>
                        </p></td>
                    </tr>
                  </tbody>
                </table>
                ...
                <h5 style="text-align: center;">
                  <span style="text-decoration: underline;"><strong>Your job is to simply “want to change enough to just be
                    there”. </strong></span>
                </h5>
                ...
                <p>You can also choose to have your laboratory tests done at your home, office, or wherever you want us
                  to meet you.</p>
                <p>
                  For Appointments, simply <a href="contact.php">contact us</a> and we will do
                  our best to schedule a mutually acceptable date and time. If you want to specifically see one of our
                  health care providers please let us know when you are scheduling an appointment. Feel free to contact
                  us with any comments you may have. We seek to always improve and count on your input.
                </p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
              </div>
        ...
        <div class="wpb_column vc_column_container col-sm-4">
          <div class="wpb_wrapper">
            ...
            <div role="form" class="wpcf7" id="wpcf7-f281-p2066-o1" lang="en-US" dir="ltr">
...
<div>
    ...
    <p align="center">
<a href="contact.php">
<img border="0" src="images/Bookcontact_us_icon.png" width="250" height="234"></a></p>
<p align="center"><b>
<a href="contact.php">Click Here</a></b></p>
